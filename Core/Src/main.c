...
/* USER CODE BEGIN Header_DrivingTask_Init */
/**
...
/* USER CODE BEGIN Header_flameTask_Init */
/**
* @brief Function implementing the flameTask thread.
* @param argument: Not used
* @retval None
*/
